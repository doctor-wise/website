...
interface ShieldZapProps {
  size?: number;
  className?: string;
}

export const ShieldZap: React.FC<ShieldZapProps> = ({ 
  size = 24, 
  className = '' 
}) => {
  return (
